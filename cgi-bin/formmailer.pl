...
BEGIN
{
  ...
  $postmaster        = 'webmaster@rainhof-gmeiner.de';
  @referers          = qw(rainhof-gmeiner.de);
  @allow_mail_to     = qw(reservierung@rainhof-gmeiner.de);
  @recipients        = ();
  %recipient_alias   = (
       'reservierung'  => 'reservierung@rainhof-gmeiner.de,reservierung@janosevic.net',
    );
